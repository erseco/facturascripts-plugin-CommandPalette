...
Before pushing code, you can run tests locally using the Makefile:
...
4. **Download the ZIP** from the release and upload it to FacturaScripts.com if you want to publish it publicly
